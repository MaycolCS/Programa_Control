<?php
    ...
    $Legalizaciones = listaLegalizacionesCXPSinAnular();
    $cant_Legalizaciones = count($Legalizaciones);
    if ($cant_Legalizaciones == 0) {
        header("Location: ../MainPage.php? cc=$Documento&cs=$CS&msj=LSLCXPPA");
        exit();
    }
        ...
        <section>
            ...
            if ($Legalizacion=="") {?>
                <form class="form_Style" method="post" action="AnularLegalizacion? cc=<?php echo $Documento; ?>&cs=<?php echo $CS; ?>">
                    <p class="txt_Titulo">Anular legalización CXP</p>
                    <div>
                ...
                <div id="tabla_vistaEscritorio">
                    ...
                    <table class="tabla_encabezado">
                        ...
                        <tr>
                            ...
                            <td class="datos_variables" colspan="4"><?php echo $DatosLegalizacion[16]; ?></td>
                    ...
                    <table class="tabla_footer">
                        ...
                        <tr>
                            ...
                            <td class="datos_variables">$ <?php if ($ValorSubtotalItems > 895000) { echo number_format(($ValorSubtotalItems*0.025));} else { echo 0;} ?></td>
