...
<head>
    ...
    <body>
        ...
        <section>
            ...
            <?php
            if ($Tercero==0) {?>
                <form class="form_Style" method="post" action="EliminarPlantaT.php? cc=<?php echo $Documento; ?>&cs=<?php echo $CS; ?>">
                    <p class="txt_Titulo">Eliminar planta</p>
                    <div>
                        <label>Tercero:</label>
            ...
            <?php
                ...
                <form name="form" class="form_Style" method="post" action="EliminarPlantaTDB? cc=<?php echo $Documento; ?>&cs=<?php echo $CS; ?>&PT=<?php echo $PlantaTercero ;?>">
                    <p class="txt_Titulo">Eliminar planta</p>
                    <div>
                        <label>Nit:</label>
